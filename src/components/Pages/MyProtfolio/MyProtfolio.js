          ...
          <div className="mt-6">
            ...
            <div className="mt-3">
              ...
              <ul>
                ...
                <li className="ml-8 list-disc">
                  When the user clicks to book now button if a user is not
                  logged in then redirect user to the login page
                </li>
              </ul>
              <a
