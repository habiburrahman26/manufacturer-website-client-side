...
const Blogs = () => {
  return (
    <>
      ...
      <div className="px-3 lg:px-32 mt-10 pb-20">
        <div className="border-2 mt-4 rounded-md p-4">
          ...
          <p>
            ...
            components to prevent unnecessary re-renders, Keeping component
            state local where necessary, Windowing or list virtualization in
            React and Lazy loading images in React.
          </p>
        </div>
        <div className="border-2 mt-4 rounded-md p-4">
          <h3 className="text-base lg:text-lg font-semibold">
          ...
          <p>
            There are lots of ways to manage state in a React application such
            as useState, useReducer, ContextApi, Redux, Redux toolkit, Recoil
            and Jotai etc.
          </p>
        </div>
        <div className="border-2 mt-4 rounded-md p-4">
          ...
          <p>
            ...
            extended, and copied.prototypical inheritance refers to the ability
        ...
        <div className="border-2 mt-4 rounded-md p-4">
          ...
          <p>
            ...
            standalone modules. We use Unit testing to reduces Defects in the
            Newly developed features or reduces bugs when changing the existing
            functionality and Improves design and allows better refactoring of
            code.
          </p>
        </div>
      </div>
